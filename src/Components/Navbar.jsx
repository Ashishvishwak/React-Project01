  ...
  return (
    <>
      <div className="w-full fixed z-[999]">
        <div className="navbar max-w-screen-2xl mx-auto text-white px-5 py-5 sm:py-10 sm:px-10 flex items-center justify-between">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <svg
              ...
              className="text-white min-w-20 md:max-w-28"
              data-v-1932cced=""
            >
              <path
          ...
          <motion.div
            ...
            transition={{ easeInOut, duration: 1.5 }}
            viewport={{ once: true }}
            className="phone-menu sm:hidden"
          >
            <span>
          ...
          <motion.div
            ...
            transition={{ easeInOut, duration: 1.5 }}
            viewport={{ once: true }}
            className="Nav-link gap-5 hidden sm:flex items-center "
          >
